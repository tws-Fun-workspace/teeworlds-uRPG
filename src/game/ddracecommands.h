...
CONSOLE_COMMAND("invis", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConInvis, this, "Makes player v invisible", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("vis", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConVis, this, "Makes player v visible again", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("tele", "vi", CFGFLAG_SERVER|CMDFLAG_TEST, ConTeleport, this, "Teleports player v to player i", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("freeze", "v?i", CFGFLAG_SERVER|CMDFLAG_TEST, ConFreeze, this, "Freezes player v for i seconds (infinite by default)", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("unfreeze", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnFreeze, this, "Unfreezes player v", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("addweapon", "v?i", CFGFLAG_SERVER|CMDFLAG_TEST, ConAddWeapon, this, "Gives weapon with id i to player v (all = -1, hammer = 0, gun = 1, shotgun = 2, grenade = 3, rifle = 4, ninja = 5)", 1)
CONSOLE_COMMAND("removeweapon", "v?i", CFGFLAG_SERVER|CMDFLAG_TEST, ConRemoveWeapon, this, "removes weapon with id i from player v (all = -1, hammer = 0, gun = 1, shotgun = 2, grenade = 3, rifle = 4)", 1)
CONSOLE_COMMAND("shotgun", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConShotgun, this, "Gives a shotgun to player v", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("grenade", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConGrenade, this, "Gives a grenade launcher to player v", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("rifle", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConRifle, this, "Gives a rifle to player v", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("weapons", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConWeapons, this, "Gives all weapons to player v", IConsole::CONSOLELEVEL_ADMIN)
...
CONSOLE_COMMAND("ninja", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConNinja, this, "Makes player v a ninja", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("super", "v", CFGFLAG_SERVER|CMDFLAG_TEST, ConSuper, this, "Makes player v super", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("unsuper", "v", CFGFLAG_SERVER, ConUnSuper, this, "Removes super from player v", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("left", "?v", CFGFLAG_SERVER|CMDFLAG_TEST, ConGoLeft, this, "Makes you or player v move 1 tile left", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("right", "?v", CFGFLAG_SERVER|CMDFLAG_TEST, ConGoRight, this, "Makes you or player v move 1 tile right", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("up", "?v", CFGFLAG_SERVER|CMDFLAG_TEST, ConGoUp, this, "Makes you or player v move 1 tile up", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("down", "?v", CFGFLAG_SERVER|CMDFLAG_TEST, ConGoDown, this, "Makes you or player v move 1 tile down", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("move", "vii", CFGFLAG_SERVER|CMDFLAG_TEST, ConMove, this, "Moves player i to the tile with x/y-number ii", IConsole::CONSOLELEVEL_HELPER)
CONSOLE_COMMAND("move_raw", "vii", CFGFLAG_SERVER|CMDFLAG_TEST, ConMoveRaw, this, "Moves player i to the point with x/y-coordinates ii",IConsole::CONSOLELEVEL_HELPER)
