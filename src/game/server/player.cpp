...
void CPlayer::LoadCharacter()
{
	...
	//XXLDDRace
	m_pCharacter->m_Bloody = m_PauseInfo.m_Bloody;
	m_pCharacter->m_ReloadMultiplier = m_PauseInfo.m_ReloadMultiplier;
	m_pCharacter->m_FastReload = m_PauseInfo.m_FastReload;
	m_pCharacter->m_LastIndexTile = m_PauseInfo.m_LastIndexTile;
	m_pCharacter->m_LastIndexFrontTile = m_PauseInfo.m_LastIndexFrontTile;
	m_pCharacter->m_Bloody = m_PauseInfo.m_Bloody;
	m_pCharacter->m_RescuePos = m_PauseInfo.m_RescuePos;
	m_pCharacter->m_LastRescue = m_PauseInfo.m_LastRescue;
	m_pCharacter->m_LastRescueSave = m_PauseInfo.m_LastRescueSave;
	m_PauseInfo.m_Respawn = false;
	m_InfoSaved = false;
}
...
void CPlayer::SaveCharacter()
{
	...
	//XXLDDrace
	m_PauseInfo.m_Bloody = m_pCharacter->m_Bloody;
	m_PauseInfo.m_ReloadMultiplier = m_pCharacter->m_ReloadMultiplier;
	m_PauseInfo.m_FastReload = m_pCharacter->m_FastReload;
	m_PauseInfo.m_LastIndexTile = m_pCharacter->m_LastIndexTile;
	m_PauseInfo.m_LastIndexFrontTile = m_pCharacter->m_LastIndexFrontTile;
	m_PauseInfo.m_Bloody = m_pCharacter->m_Bloody;
	m_PauseInfo.m_RescuePos = m_pCharacter->m_RescuePos;
	m_PauseInfo.m_LastRescue = m_pCharacter->m_LastRescue;
	m_PauseInfo.m_LastRescueSave = m_pCharacter->m_LastRescueSave;
	m_PauseInfo.m_HammerType = m_pCharacter->m_HammerType;
}
