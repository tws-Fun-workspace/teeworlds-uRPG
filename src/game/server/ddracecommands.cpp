...
void CGameContext::ConCredits(IConsole::IResult *pResult, void *pUserData, int ClientID)
{
	...
	pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "Modded mod my XXLTomate.");
	pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "Infos at XXL-Clan.com.");
}
...
void CGameContext::ConInfo(IConsole::IResult *pResult, void *pUserData, int ClientID)
{
	...
	pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "-->XXLDDRace<--"); 
        pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "Mod by XXLTomate based on"); 
	pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "DDRace Mod. Version: " GAME_VERSION); 
	pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "XXLDDRace Mod. Version: " XXL_VERSION); 
	pResult->Print(IConsole::OUTPUT_LEVEL_STANDARD, "info", "Download and infos at XXL-Clan.com"); 
