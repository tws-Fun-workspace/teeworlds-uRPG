...
MACRO_CONFIG_INT(SvForceShrine, sv_force_shrine, 1, 0, 1, CFGFLAG_SERVER, "if on, only shrine tiles act as shrine. otherwise, also death tiles do. leaving the game layer never does.")
// debug
