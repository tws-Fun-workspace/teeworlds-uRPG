...
MACRO_CONFIG_INT(SvHammerScaleX, sv_hammer_scale_x, 100, 1, 1000, CFGFLAG_SERVER, "linearly scale up hammer x power, percentage")
MACRO_CONFIG_INT(SvHammerScaleY, sv_hammer_scale_y, 100, 1, 1000, CFGFLAG_SERVER, "linearly scale up hammer y power, percentage")
