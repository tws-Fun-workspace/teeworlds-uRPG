...
MACRO_CONFIG_INT(SvThrottle, sv_throttle_fgts, 0, 0, 60, CFGFLAG_SERVER, "")
...
MACRO_CONFIG_INT(SvSkinStealAction, sv_skinstealaction, 1, 0, 1, CFGFLAG_SERVER, "How to punish skin stealing (currently only 1 = force pinky)")
...
MACRO_CONFIG_INT(SvFlag0HeatCap, sv_flag0_heat_cap, 10, 0, 10, CFGFLAG_SERVER, "Maximum heat which can be regenerated by the means of flag 0")
MACRO_CONFIG_INT(SvFlag1HeatCap, sv_flag1_heat_cap, 10, 0, 10, CFGFLAG_SERVER, "Maximum heat which can be regenerated by the means of flag 1")
MACRO_CONFIG_INT(SvTakeFlagSound, sv_take_flag_sound, 0, 0, 1, CFGFLAG_SERVER, "Enable (1) or disable (0) a sound when the flag is picked up or transfered")
