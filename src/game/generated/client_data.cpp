...
static CDataSoundset x9[] = {
	...
	/* x9[31] */ {  "hit",  2,x2425,  -1, },
    /* x9[32] */ {  "chat_client",  1,x2438,  -1, },
	/* x9[33] */ {  "chat_server",  1,x2448,  -1, },
...
static CDataSprite x44[] = {
	...
	/* x44[98] */ {  "file_demo1",  &x28[7],  0,  0,  1,  1, },
	/* x44[99] */ {  "file_demo2",  &x28[7],  1,  0,  1,  1, },
	/* x44[100] */ {  "file_folder",  &x28[7],  2,  0,  1,  1, },
	/* x44[101] */ {  "file_map1",  &x28[7],  5,  0,  1,  1, },
	/* x44[102] */ {  "file_map2",  &x28[7],  6,  0,  1,  1, },
	/* x44[103] */ {  "guibutton_off",  &x28[8],  0,  0,  4,  4, },
	/* x44[104] */ {  "guibutton_on",  &x28[8],  4,  0,  4,  4, },
	/* x44[105] */ {  "guibutton_hover",  &x28[8],  8,  0,  4,  4, },
	/* x44[106] */ {  "guiicon_mute",  &x28[9],  0,  0,  4,  2, },
	/* x44[107] */ {  "guiicon_friend",  &x28[9],  4,  0,  4,  2, },
};
static CAnimKeyframe x4303[] = {
	/* x4303[0] */ {  0.000000,  0.000000,  -4.000000,  0.000000, },
};
static CAnimKeyframe x4310[] = {
	/* x4310[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe x4317[] = {
	/* x4317[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe *x4324 = 0;
static CAnimKeyframe *x4348 = 0;
static CAnimKeyframe x4355[] = {
	/* x4355[0] */ {  0.000000,  -7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4362[] = {
	/* x4362[0] */ {  0.000000,  7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe *x4369 = 0;
static CAnimKeyframe *x4388 = 0;
static CAnimKeyframe x4395[] = {
	/* x4395[0] */ {  0.000000,  -3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe x4402[] = {
	/* x4402[0] */ {  0.000000,  3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4409 = 0;
static CAnimKeyframe x4428[] = {
	/* x4428[0] */ {  0.000000,  0.000000,  0.000000,  0.000000, },
	/* x4428[1] */ {  0.200000,  0.000000,  -1.000000,  0.000000, },
	/* x4428[2] */ {  0.400000,  0.000000,  0.000000,  0.000000, },
	/* x4428[3] */ {  0.600000,  0.000000,  0.000000,  0.000000, },
	/* x4428[4] */ {  0.800000,  0.000000,  -1.000000,  0.000000, },
	/* x4428[5] */ {  1.000000,  0.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4435[] = {
	/* x4435[0] */ {  0.000000,  8.000000,  0.000000,  0.000000, },
	/* x4435[1] */ {  0.200000,  -8.000000,  0.000000,  0.000000, },
	/* x4435[2] */ {  0.400000,  -10.000000,  -4.000000,  0.200000, },
	/* x4435[3] */ {  0.600000,  -8.000000,  -8.000000,  0.300000, },
	/* x4435[4] */ {  0.800000,  4.000000,  -4.000000,  -0.200000, },
	/* x4435[5] */ {  1.000000,  8.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4442[] = {
	/* x4442[0] */ {  0.000000,  -10.000000,  -4.000000,  0.200000, },
	/* x4442[1] */ {  0.200000,  -8.000000,  -8.000000,  0.300000, },
	/* x4442[2] */ {  0.400000,  4.000000,  -4.000000,  -0.200000, },
	/* x4442[3] */ {  0.600000,  8.000000,  0.000000,  0.000000, },
	/* x4442[4] */ {  0.800000,  8.000000,  0.000000,  0.000000, },
	/* x4442[5] */ {  1.000000,  -10.000000,  -4.000000,  0.200000, },
};
static CAnimKeyframe *x4449 = 0;
static CAnimKeyframe *x4548 = 0;
static CAnimKeyframe *x4555 = 0;
static CAnimKeyframe *x4562 = 0;
static CAnimKeyframe x4569[] = {
	/* x4569[0] */ {  0.000000,  0.000000,  0.000000,  -0.100000, },
	/* x4569[1] */ {  0.300000,  0.000000,  0.000000,  0.250000, },
	/* x4569[2] */ {  0.400000,  0.000000,  0.000000,  0.300000, },
	/* x4569[3] */ {  0.500000,  0.000000,  0.000000,  0.250000, },
	/* x4569[4] */ {  1.000000,  0.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4603 = 0;
static CAnimKeyframe *x4610 = 0;
static CAnimKeyframe *x4617 = 0;
static CAnimKeyframe x4624[] = {
	/* x4624[0] */ {  0.000000,  0.000000,  0.000000,  -0.250000, },
	/* x4624[1] */ {  0.100000,  0.000000,  0.000000,  -0.050000, },
	/* x4624[2] */ {  0.150000,  0.000000,  0.000000,  0.350000, },
	/* x4624[3] */ {  0.420000,  0.000000,  0.000000,  0.400000, },
	/* x4624[4] */ {  0.500000,  0.000000,  0.000000,  0.350000, },
	/* x4624[5] */ {  1.000000,  0.000000,  0.000000,  -0.250000, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4303, },  /* x75[0].back_foot */ {  1,x4310, },  /* x75[0].front_foot */ {  1,x4317, },  /* x75[0].attach */ {  0,x4324, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4348, },  /* x75[1].back_foot */ {  1,x4355, },  /* x75[1].front_foot */ {  1,x4362, },  /* x75[1].attach */ {  0,x4369, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4388, },  /* x75[2].back_foot */ {  1,x4395, },  /* x75[2].front_foot */ {  1,x4402, },  /* x75[2].attach */ {  0,x4409, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4428, },  /* x75[3].back_foot */ {  6,x4435, },  /* x75[3].front_foot */ {  6,x4442, },  /* x75[3].attach */ {  0,x4449, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4548, },  /* x75[4].back_foot */ {  0,x4555, },  /* x75[4].front_foot */ {  0,x4562, },  /* x75[4].attach */ {  5,x4569, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4603, },  /* x75[5].back_foot */ {  0,x4610, },  /* x75[5].front_foot */ {  0,x4617, },  /* x75[5].attach */ {  6,x4624, }, },
};
static CDataSprite* *x4781 = 0;
static CDataSprite* x4918[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5103[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5288 = 0;
static CDataSprite* *x5425 = 0;
static CDataSprite* x5562[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4781,  96,  125,  10,  0,  3,  4.000000,  -20.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x4918,  64,  125,  10,  500,  1,  32.000000,  4.000000,  50.000000,  6.000000,  5.000000, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5103,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  70.000000,  6.000000,  5.000000, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5288,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5425,  92,  800,  10,  0,  5,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5562,  96,  800,  10,  0,  9,  0.000000,  0.000000,  40.000000,  -4.000000,  5.000000, },
};
