...
MACRO_CONFIG_STR(SvRconPasswordAdmin, sv_admin_pass, 32, "", CFGFLAG_SERVER, "Remote console administrator password", IConsole::CONSOLELEVEL_CONFIG)
MACRO_CONFIG_STR(SvRconPasswordModer, sv_mod_pass, 32, "", CFGFLAG_SERVER, "Remote console moderator password", IConsole::CONSOLELEVEL_CONFIG)
...
MACRO_CONFIG_INT(SvDmgBlood, sv_dmg_blood, 0, 0, 1, CFGFLAG_SERVER, "Turns blood on damage on/off", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvHybridMode, sv_hybrid_mode, 0, 0, 1, CFGFLAG_SERVER, "Turns hybrid mode on/off", IConsole::CONSOLELEVEL_CONFIG)
MACRO_CONFIG_INT(SvRescue, sv_rescue, 0, 0, 1, CFGFLAG_SERVER, "Turns rescue /r on/off", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvRescueEffects, sv_rescue_effect, 0, 0, 1, CFGFLAG_SERVER, "Turns rescue effects on/off", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvLolFilter, sv_lol_filter, 1, 0, 1, CFGFLAG_SERVER, "Turns 'lol' filter on/off", IConsole::CONSOLELEVEL_CONFIG)
MACRO_CONFIG_INT(SvHelper, sv_helper, 1, 0, 1, CFGFLAG_SERVER, "Turns /helper on/off", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvSilentXXL, sv_silent_xxl, 0, 0, 1, CFGFLAG_SERVER, "Makes XXL silent.", IConsole::CONSOLELEVEL_CONFIG)
MACRO_CONFIG_INT(SvRconScore, sv_rcon_score, 0, 0, 1, CFGFLAG_SERVER, "Shows the rcon lvl in scoreboard.", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvWhisperLevel, sv_whisper_lvl, 1, -1, 4, CFGFLAG_SERVER, "Sets the rcon lvl to whisper", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvWhisperAdmin, sv_whisper_allow_to_admin, 0, 0, 1, CFGFLAG_SERVER, "Allows to whisper to admins", IConsole::CONSOLELEVEL_ADMIN)
...
MACRO_CONFIG_INT(SvRMNinjaResetVel, sv_rmninja_reset_vel, 0, 0, 1, CFGFLAG_SERVER, "Shows new score and checkpoints in laserfont above the player", IConsole::CONSOLELEVEL_ADMIN)
MACRO_CONFIG_INT(SvFainbowFeet, sv_rainbow_feet, 0, 0, 1, CFGFLAG_SERVER, "The feets of the tees are rainbow", IConsole::CONSOLELEVEL_ADMIN)
