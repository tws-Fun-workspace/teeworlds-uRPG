...
MACRO_CONFIG_STR(SvName, sv_name, 128, "unnamed OpenFNG32 server", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_INT(SvAuxPort, sv_aux_port, 0, 0, 65535, CFGFLAG_SERVER, "Auxilary port for displaying all 32 players in server browser")
