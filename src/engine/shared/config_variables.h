...
MACRO_CONFIG_STR(SvBroadcast, sv_broadcast, 64, "", CFGFLAG_SERVER, "The broadcasting message")
...
MACRO_CONFIG_INT(SvShotgunBulletSound, sv_shotgun_bullet_sound, 1, 0, 1, CFGFLAG_SERVER, "Crazy shotgun bullet sound on/off")
...
MACRO_CONFIG_INT(SvVotePauseTime, sv_vote_pause_time, 10, 0, 99999, CFGFLAG_SERVER, "The time (in seconds) players have to wait in pause when paused by vote")
...
MACRO_CONFIG_STR(SvRconKidPassword,       sv_kid_password, 32, "kit-kat", CFGFLAG_SERVER, "Remote console password for kid's (limited access)")
MACRO_CONFIG_INT(SvCheats,                sv_cheats, 0, 0, 1, CFGFLAG_SERVER, "Finish with cheats")
...
MACRO_CONFIG_INT(SvEffects,               sv_effects, 1, 0, 1, CFGFLAG_SERVER, "Turns effects on/off")
MACRO_CONFIG_INT(SvShotgunWall,           sv_shotgun_wall, 0, 0, 1, CFGFLAG_SERVER, "Shotgun-wall")
MACRO_CONFIG_INT(SvShotgunWallTime,       sv_shotgun_wall_time, 10, 0, 600, CFGFLAG_SERVER, "The time (in seconds) for shotgun walls")
MACRO_CONFIG_INT(SvShotgunWallLength,     sv_shotgun_wall_length, 2, 1, 10, CFGFLAG_SERVER, "Shotgun walls length")
MACRO_CONFIG_INT(SvUnfreeze,              sv_unfreeze, 1, 0, 1, CFGFLAG_SERVER, "Enable to use /unfreeze")
MACRO_CONFIG_INT(SvSaveImpulse,           sv_save_impulse, 1, 0, 1, CFGFLAG_SERVER, "Save impulse when you say /d or /r")
MACRO_CONFIG_INT(SvSounds,                sv_sounds, 1, 0, 1, CFGFLAG_SERVER, "Turn all sounds on/off")
MACRO_CONFIG_INT(SvFloodBan,              sv_flood_ban, 5, 0, 1440, CFGFLAG_SERVER, "The time a client gets banned for flood")
MACRO_CONFIG_INT(SvTestDummy,             sv_test_dummy, 0, 0, 1, CFGFLAG_SERVER, "Never use, NEVER!!")
...
MACRO_CONFIG_INT(SvGrenadeExplosive,      sv_grenade_explosive, 1, 0, 1, CFGFLAG_SERVER, "Grenade explosive")
